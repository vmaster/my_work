...
function insertar($id,$us, $pw, $tipousuario)
 {
	...
	$sql = "INSERT INTO usuario(idusuario,us,pw,idtipousuario,estado) VALUES('".$id."','". $us ."','". $pw ."','". $tipousuario ."','N')";
   global $cnx;
   return $cnx->query($sql);  	
	...
	$dato=$rst->fetch();
		...
		$sql = "UPDATE usuario SET  us='". $us ."', pw ='". $pw ."', idtipousuario='". $tipousuario ."', estado='N' WHERE idusuario = " . $id;
		global $cnx;
		return $cnx->query($sql);  
		}
	}
...
function logeo($Usuario, $Clave)
 {
   ...
   if(isset($Usuario) and isset($Clave))
	$sql = $sql . " AND US = '$Usuario' AND PW = '$Clave'";
