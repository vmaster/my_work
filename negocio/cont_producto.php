...
function controlador($accion)
{
  ...
  try{    
	...
	$ObjProducto->insertar($_POST['txtIdProducto'], $codigo, utf8_decode($_POST['txtDescripcion']), $_POST['cboCategoria'], $_POST['cboMarca'], $_POST['cboUnidadBase'], $_POST['txtPeso'], $_POST['cboMedidaPeso'],$_POST['txtStockSeguridad'], $_POST['cboArmario'], $_POST['cboColumna'],$_POST['cboFila'], $_POST['cboKardex'], $_POST['cboColor'], $_POST['cboTalla'], $_POST['cboRecetaMedica']);
  ...
  try{    
	...
	$ObjProducto->actualizar($_POST['txtIdProducto'], $_POST['txtCodigo'], utf8_decode($_POST['txtDescripcion']), $_POST['cboCategoria'], $_POST['cboMarca'], $_POST['cboUnidadBase'], $_POST['txtPeso'], $_POST['cboMedidaPeso'],$_POST['txtStockSeguridad'], $_POST['cboArmario'], $_POST['cboColumna'],$_POST['cboFila'], $_POST['cboKardex'], $_POST['cboColor'], $_POST['cboTalla'], $_POST['cboRecetaMedica']);
