...
<center>
<fieldset>
<legend>Detalle de Pedido de Sucursal</legend>
<table width="858" height="108" border="0">
  ...
  <tr>
    ...
    <td><?php echo $detalle2->sucursal;?></td>
...
<table width="861" height="27" class="tablaint">
  ...
  <tr>
    ...
    <td><?php //echo $dato->producto.' /'.$dato->categoria.'-'.$dato->marca.'-'.$dato->peso.$dato->unidadpeso;?><?php echo $dato->producto.' /'.$dato->categoria.'-'.$dato->marca.'-'.$dato->color.'-'.$dato->talla;?></td>
...
<table width="858" border="0">
  <tr>
	...
	<?php }else{?>
      <input type="button" name="Submit" value="Regresar" onClick="javascript:window.open('<?php if($_GET['origen']=='PA') echo 'list_pedidoventa.php'; else echo 'list_pedidosucursal.php';?>','_self')">
	  <?php }?>
    </label></td>
