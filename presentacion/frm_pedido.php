...
<div id="titulo01">REGISTRO DE PEDIDO </div>
<form id="frmPedido" action="../negocio/cont_pedido.php?accion=NUEVO" method="POST" onSubmit='return check_form(frmPedido);'>
<table width="100%">
<tr>
<td colspan="2">
...
//}
  ...
  <tr>
    ...
    <td><input type='hidden' name = 'txtIdPersona' id="txtIdPersona" value = ''>
        ...
        <button type="button" class="boton" onClick="javascript: mostrarBusqueda(0);">...</button></td>
...
<fieldset>
  ...
  <input type="submit" name="button" id="button" value="Guardar">
    ...
    <label>
    <input type="button" name="Submit" value="Cancelar" onClick="javascript:window.open('list_pedido.php','_self')">
    </label>
