...
function enlistar(){
<?php 
	$fgenerarventasalmacen->printScript();
?>
}
function generarinicio(){
	xajax_generarventasalmaceninicio();
...
<div id="titulo01">LISTADO DE VENTAS A DESPACHAR</div>
  ...
  <div id='divParametros'>
    <fieldset>
      ...
      <tr>
        ...
        <td colspan="7"><select name="cboVer" id="cboVer"><!-- onChange="activacion()"-->
...
//]]></script></td>
      ...
      <tr>
        <td width="83" height="50" class="alignright">Tipo Doc.:</td>
...
//]]></script></td>
        ...
        <td width="98"><input name = 'BTNGUIA' type='button' id="BTNGUIA" value = 'NUEVA GUIA REM.' onClick="javascript:window.open('frm_guiaremision.php','_self')"></td>
        <td width="131">&nbsp;</td>
      </tr>
    </table>
    </fieldset>
