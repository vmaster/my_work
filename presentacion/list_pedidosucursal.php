...
function enlistar(){
<?php 
	$fgenerarpedidossucursal->printScript();
?>
}
...
<link href="../css/estilosistema.css" rel="stylesheet" type="text/css">
    <head>
<title>PEDIDOS DE SUCURSALES</title>
</head>
<body onLoad="enlistar()">
...
<div id="titulo01">LISTADO DE PEDIDOS DE SUCURSALES</div>
  ...
  <div id='divParametros'>
    <fieldset>
      ...
      <tr>
        ...
        <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td rowspan="3"><img src="../imagenes/notas.gif" width="100" height="100"></td>
        </tr>
      <tr>
...
//]]></script></td>
        ...
        <td width="98"><input name = 'NUEVO' type='button' id="NUEVO" value = 'NUEVO PEDIDO' onClick="javascript:window.open('frm_pedidosucursales.php','_self')"></td>
