...
<div id="titulo01">LISTADO DE SECTORES</div>
<form action="mant_sector.php?accion=NUEVO" method="POST">
...
<td><?php echo $dato->IdSector?></td>
<td><?php echo $dato->descripcion?></td>
<td><a href="mant_sector.php?accion=ACTUALIZAR&IdSector=<?php echo $dato->IdSector;?>"> <img src="../imagenes/editar_.jpg" width="16" height="16">Actualizar </a></td>
<td><a href="../negocio/cont_sector.php?accion=ELIMINAR&IdSector=<?php echo $dato->IdSector;?>"> <img src="../imagenes/eliminar.jpg" width="16" height="16">Eliminar </a></td>
</tr>
<?php }?>
  <tr>
