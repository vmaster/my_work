...
function enlistar(){
<?php 
	$fgenerarpedidoventas->printScript();
?>
}
function generarinicio(){
	xajax_generarpedidosventasinicio();
...
<link href="../css/estilosistema.css" rel="stylesheet" type="text/css">
    <head>
<title>PEDIDOS POR ATENDER</title>
</head>
...
<div id="titulo01">LISTADO DE PEDIDOS POR ATENDER</div>
  ...
  <div id='divParametros'>
    <fieldset>
      ...
      <tr>
        ...
        <td></td><td></td><td></td><td></td><td></td><td></td><td rowspan="3"><img src="../imagenes/New Blue System 038.png" width="100" height="100"></td>
        </tr>
      <tr>
...
//]]></script></td>
        ...
        <td width="98"><input name = 'NUEVO' type='button' id="NUEVO" value = 'NUEVA PEDIDO' onClick="javascript:window.open('frm_pedido.php','_self')" style="display:none"></td>
