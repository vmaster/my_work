...
$tabla="<fieldset>
    ...
    <tr>
      ...
      <th colspan='2' align='center'>EGRESO</th>
      <th colspan='2' align='center'>TOTALES</th>
    </tr>
    <tr>
      <th width='150' align='center'>AÑO</th>
      <th width='150' align='center'>DOLARES</th>
      <th width='150' align='center'>SOLES</th>
      <th width='150' align='center'>DOLARES</th>
      <th width='150' align='center'>SOLES</th>
      <th width='200' align='center'>TOTAL DOLARES </th>
      <th width='200' align='center'>TOTAL SOLES </th>
    </tr>";
	$Ob = new clsMovCaja();		
	...
	$tabla.="<td align='center'>".number_format($IDano,2)."</td>";
	$tabla.="<td align='center'>".number_format($ISano,2)."</td>";
	$tabla.="<td align='center'>".number_format($EDano,2)."</td>";
	$tabla.="<td align='center'>".number_format($ESano,2)."</td>";
	$tabla.="<td align='center'>".number_format(($IDano-$EDano),2)."</td>";
	...
	$tabla.="<th align='center'>$. ".number_format($ID,2)."</th>";
	$tabla.="<th align='center'>S/. ".number_format($IS,2)."</th>";
	$tabla.="<th align='center'>$. ".number_format($ED,2)."</th>";
	$tabla.="<th align='center'>S/. ".number_format($ES,2)."</th>";
	$tabla.="<th align='center'>$. ".number_format(($ID-$ED),2)."</th>";
	$tabla.="<th align='center'>S/. ".number_format(($IS-$ES),2)."</th>";
    $tabla.="</tr>";
	
  	$tabla.="</table></fieldset>";

	$tabla.="<center><a href=\"#\" onClick=javascript:window.open('pdf_movcajaRptYear.php?idtipodoc=$idtipodocumento&idrolpersona=$idrolpersona&yearI=$yearinicio&yearF=$yearfin&idconceptopago=$idconceptopago&moneda=$moneda','_blank')><img src=\"../imagenes/print_f2.png\" with=20 height=20>&nbsp;Imprimir</a>&nbsp;";
...
$tabla="<fieldset>
                <legend><strong>REPORTE:</strong></legend>
	<table width='1450' class=registros>
    <tr>
      <th align='center'>--</th>
      <th colspan='2' align='center'>INGRESO</th>
      <th colspan='2' align='center'>EGRESO</th>
    ...
    <tr>
      <th width='150' align='center'>MES</th>
      <th width='200' align='center'>DOLARES</th>
      <th width='200' align='center'>SOLES</th>
      <th width='200' align='center'>DOLARES</th>
      <th width='200' align='center'>SOLES</th>
      <th width='250' align='center'>TOTAL DOLARES </th>
      <th width='250' align='center'>TOTAL SOLES </th>
    </tr>";
	$Ob = new clsMovCaja();		
	...
	$tabla.="<td align='center'>".number_format($IDmes,2)."</td>";
	$tabla.="<td align='center'>".number_format($ISmes,2)."</td>";
	$tabla.="<td align='center'>".number_format($EDmes,2)."</td>";
	$tabla.="<td align='center'>".number_format($ESmes,2)."</td>";
	$tabla.="<td align='center'>".number_format(($IDmes-$EDmes),2)."</td>";
	...
	$tabla.="<center><a href=\"#\" onClick=javascript:window.open('pdf_movcajaRptMes.php?idtipodoc=$idtipodocumento&idrolpersona=$idrolpersona&mesI=$mesinicio&mesF=$mesfin&idconceptopago=$idconceptopago&moneda=$moneda&year=$year','_blank')><img src=\"../imagenes/print_f2.png\" with=20 height=20>&nbsp;Imprimir</a>&nbsp;";
	$_SESSION['data1']=$datos1;
	$_SESSION['data2']=$datos2;
	$tabla.="<a href=\"#\" onclick=\"javascript: if(document.getElementById('divGrafico').style.display=='') document.getElementById('divGrafico').style.display='none'; else document.getElementById('divGrafico').style.display=''\"><img src=\"../imagenes/estadistica.png\" with=20 height=20>&nbsp;ver Gr&aacute;fico</a></center><br>";
...
if($num==0){
		...
		$tabla="<b>MONEDA: SOLES</b><p>No existen Reportes..!</p>";
		
}else{
$tabla="<fieldset>
                <legend><strong>REPORTE:</strong></legend>
				<b>MONEDA: SOLES</b>
				<table width='1350' class=registros>
                <tr>
...
<table width='1350' align='center' class=registros>
	   ...
	   if($cont%2) $estilo="par"; else $estilo="impar";
		...
		$tabla.="</tr>";
		 ...
		 $tabla.="<input name='txtImprimir' type='button' id='IMPRIMIR' value='IMPRIMIR' onClick=javascript:window.open('pdf_movcajaRptDia.php?idtipodoc=$idtipodocumento&idrolpersona=$idrolpersona&fech=$fech&idconceptopago=$idconceptopago&moneda=$moneda','_blank')></fieldset>";
