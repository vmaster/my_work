...
$pdf->Cell(280,10,'REPORTE DE MOVIMIENTO DE CAJA POR MES',0,1,'C');
$pdf->Ln();
...
$mesF=$mesinicio;
	...
	$pdf->Cell(35,8,number_format($Ob->reportesmes(10,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesmes(10,$idrolpersona,$idconceptopago,'S','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesmes(11,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesmes(11,$idrolpersona,$idconceptopago,'S','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(50,8,number_format(($Ob->reportesmes(10,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year)-$Ob->reportesmes(11,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year)),2),1,0,'C');
