...
function seleccionar(idproducto,moneda){
	document.getElementById('divDatosProdSel').style.display='';
...
function agregar(){
  ...
  document.getElementById('divDatosProdSel').style.display='none';
}
...
<div id="titulo01">DESPACHO DE PEDIDO DE SUCURSAL</div>
<form id="frmVenta" action="../negocio/cont_venta.php?accion=NUEVO-PEDIDO&origen=<?php if($_GET['accion']=='NUEVO') echo 'VENTA'; else echo 'PEDIDO';?>" method="POST" onSubmit='return check_form(frmVenta);'>
<table>
<tr>
<td colspan="3">
...
<table width="792" border="0">
  <tr>
    <td width="66" class="alignright" style="display:none">Tipo:. </td>
    <td width="189" style="display:none"><select id="cboTipoVenta" name="cboTipoVenta" onChange="mostrarcuota();">
  ...
  <td width="33" class="alignright" style="display:none">Doc.:</td>
    <td width="130" style="display:none"><select id="cboTipoDocumento" name="cboTipoDocumento" size="1" onChange="cambiarmonedadetalle();generarnumero()">
      <option value="15">Despacho Pedido Sucursal</option>
    </select>      </td>
    ...
    <td width="57" class="alignright" style="display:none">Moneda:</td>
    <td width="99" style="display:none"><select id="cboMoneda" name="cboMoneda" onChange="cambiarmonedadetalle();">
      <option value="S">Soles</option>
      <option value="D">Dolares</option>
    </select></td>
    </tr>
  <tr>
    <td class="alignright">Sucursal Destino:</td>
    <td><input type='hidden' name = 'txtIdPersona' id="txtIdPersona" value = ''>
        <input type='text' name = 'txtNombresPersona' id="txtNombresPersona" style="text-transform:uppercase;background-color:#CCC"  readonly='true' value = ''>
        <button type="button" class="boton" onClick="mostrarBusqueda(0)" disabled>...</button></td>
    <td>&nbsp;</td>
...
//}
  ...
  <tr>
    ...
    <td class="alignright">Pedido Ref.</td>
    <td><input type="hidden" name="txtIdMovimientoRef" id="txtIdMovimientoRef" value="0">
      ...
      <input type='text' name = 'txtReferencia' id="txtReferencia" readonly='true' value = '' style="background-color:#CCC">
      <button type="button" class="boton" onClick="mostrarBusqueda(10)" disabled>...</button>
      <BR>
      <div id="divactualizar"> </div></td>
    <td colspan="2">&nbsp;</td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<select name="campo" id="campo" onChange="buscar()">
...
<div id="divregistros"></div></fieldset>
</td></tr>
<tr>
<td colspan="3">
<center>
<fieldset id="divDatosProdSel" style="display:none"><legend><strong>DATOS DEL PRODUCTO SELECCIONADO:</strong></legend>
<table>
<tr>
...
<tr><td class="registros">Nota: Asegurese que los datos de la sucursal de destino sean los correctos y que se muestre el detalle del pedido.</td></tr>
</table>
</form>
</body>
</html>