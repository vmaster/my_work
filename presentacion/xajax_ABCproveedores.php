...
function generareporte($idzona,$idsector,$fechainicio,$fechafin,$idtipodocumento,$formapago,$moneda){
	...
	*/
	...
	$registro.="<tr><th>TOTAL COMPRA: </th><td>".$mon.number_format($total,2)."<td></tr>
    <tr>
      
	  <th><div align='center'>TIPO PROVEEDOR</div></th>
	  ...
	  <th><div align='center'>ULTIMA COMPRA</div></th>
	...
	$registro.="</table>";
	$registro.="<input name='txtImprimir' type='button' id='IMPRIMIR' value='IMPRIMIR' onClick=javascript:window.open('pdf_ABCproveedores.php?idzona=$idzona&idsector=$idsector&inicio=$fechainicio&final=$fechafin&tipodoc=$idtipodocumento&formap=$formapago&moneda=$moneda','_blank')>";
	$registro=utf8_encode($registro);
	$obj=new xajaxResponse();
//	$obj->alert($idzona.$idsector.$fechainicio.$fechafin.$idtipodocumento.$formapago.$moneda);
