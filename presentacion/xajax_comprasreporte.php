...
function generareporte($fechainicio,$fechafin,$moneda,$agrupado){
   ...
   $objMovimiento = new clsMovimiento();
	$rst = $objMovimiento->consultarreportecompra($fechainicio,$fechafin,$moneda,$agrupado);
...
if($cont%2) $estilo="par";else $estilo="impar";
	...
	$registro.="<center><a href=\"#\" onClick=javascript:window.open('pdf_compras.php?inicio=$fechainicio&final=$fechafin&formap=$formapago&moneda=$moneda&agrupado=$agrupado','_blank')><img src=\"../imagenes/print_f2.png\" with=20 height=20>&nbsp;Imprimir</a>&nbsp;";
	$_SESSION['data']=$datos;
	...
	$registro.='<div id="divGrafico" style="display:none"><center><div id="titulo01">Gr&aacute;fico de Compras</div><img src="grafico2.php"/></center></div>';
