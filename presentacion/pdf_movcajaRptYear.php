...
$pdf->Cell(280,10,'REPORTE DE MOVIMIENTO DE CAJA POR AÑO',0,1,'C');
$pdf->Ln();
...
$pdf->Cell(35,8,"",2,0,'C');
$pdf->Cell(70,8,"INGRESO",1,0,'C');
$pdf->Cell(70,8,"EGRESO",1,0,'C');
$pdf->Cell(100,8,"TOTALES",1,0,'C');
$pdf->Ln();

$pdf->SetFont('Arial','B',11);
$pdf->Cell(35,8,"AÑO",1,0,'C');
$pdf->Cell(35,8,"DOLARES",1,0,'C');
$pdf->Cell(35,8,"SOLES",1,0,'C');
$pdf->Cell(35,8,"DOLARES",1,0,'C');
$pdf->Cell(35,8,"SOLES",1,0,'C');
$pdf->Cell(50,8,"TOTAL DOLARES",1,0,'C');
...
$yearF=$yearinicio;
	...
	$pdf->Cell(35,8,number_format($Ob->reportesyear(10,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesyear(10,$idrolpersona,$idconceptopago,'S','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesyear(11,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(35,8,number_format($Ob->reportesyear(11,$idrolpersona,$idconceptopago,'S','CAJA','N',$i,$_SESSION['IdSucursal'],$year),2),1,0,'C');
	$pdf->Cell(50,8,number_format(($Ob->reportesyear(10,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year)-$Ob->reportesyear(11,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year)),2),1,0,'C');
	...
	$ED=$ED+$Ob->reportesyear(11,$idrolpersona,$idconceptopago,'D','CAJA','N',$i,$_SESSION['IdSucursal'],$year);
		...
		$pdf->Cell(35,8,'$. '.number_format($ID,2),1,0,'C');
		$pdf->Cell(35,8,'S/. '.number_format($IS,2),1,0,'C');
		$pdf->Cell(35,8,'$. '.number_format($ED,2),1,0,'C');
		$pdf->Cell(35,8,'S/. '.number_format($ES,2),1,0,'C');
		$pdf->Cell(50,8,'$. '.number_format(($ID-$ED),2),1,0,'C');
